...
import com.example.housewareshop.util.MathFuntion;
...
public class mainController {
    ...
    public String getListCart(Model model,HttpSession session) {
        ...
        model.addAttribute("totalMoney", MathFuntion.getMoney(totalMoney));
        return "listCart";
    }
    ...
    public String PostPrepareShipping(Model model, @RequestParam(name = "name") String name,
        ...
        order.setCreatedDate(java.sql.Date.valueOf(sdf.format(date)));
